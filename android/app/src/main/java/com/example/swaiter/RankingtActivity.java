...
public class RankingtActivity extends AppCompatActivity implements MenuAdapter.OnItemClickListener, Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    ArrayList<MenuVO> selected_menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setOwnerActivity(RankingtActivity.this);
        ...
        selected_menu = new ArrayList<>();

        textView_result = (TextView) findViewById(R.id.txt_result);
        textView_result.setText("인기 메뉴");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_shopping = new Intent(RankingtActivity.this, selectedActivity.class);
                intent_shopping.putExtra("selected", selected_menu);
    ...
    private void request() {
        ...
        progressON(RankingtActivity.this, "");
        JSONObject send = new JSONObject();
        try {
            System.out.println(result);
            send.put("result", result);
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, info.getUrl() + "Post/rank", send, this, this);
    ...
    public void dialog_sidemenu(final MenuVO menuVO) {
        ...
        button_option.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textView_totalPrice.setText(Integer.toString(price_total));
    ...
    public void addSelectedMenu (MenuVO menuVO) {
        ...
        addRowValue.put("price", textView_totalPrice.getText().toString());
